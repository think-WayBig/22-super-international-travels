    ...
    var b, c = "function" == typeof define && define.amd, d = function (b) {
        ...
        var b = function (b) {
            ...
            , Z = function (a, c) {
                ...
                if (0 === a.offset) {
                    ...
                    Y(a.node) ? (d = a.node.childNodes[a.offset - 1],
                        e = E(d)) : (d = a.node,
                            e = c ? 0 : a.offset - 1);
                return {
                    node: d,
            ...
            , $ = function (a, c) {
                ...
                if (E(a.node) === a.offset) {
                    ...
                    Y(a.node) ? (d = a.node.childNodes[a.offset],
                        e = 0) : (d = a.node,
                            e = c ? E(a.node) : a.offset + 1);
                return {
                    node: d,
                    offset: e
                }
        ...
        var b = function (a, b) {
            ...
            if (0 !== c && j.isText(h[c - 1])) {
                ...
                b && k.nextSibling && j.isText(k.nextSibling) && m === k.nodeValue.length && (m -= k.nodeValue.length,
                    k = k.nextSibling),
                    e = k,
                    c = m
            }
                ...
                this.getPoints = function () {
                    ...
                    this.nodes = function (a, b) {
                        ...
                        return j.walkPoint(e, h, function (b) {
                            if (!j.isEditable(b.node)) {
                                var e;
                                d ? (j.isLeftEdgePoint(b) && k.push(b.node),
                                    j.isRightEdgePoint(b) && g.contains(k, b.node) && (e = b.node)) : e = c ? j.ancestor(b.node, a) : b.node,
                                    e && a(e) && i.push(e)
                            }
                        }, !0),
                            g.unique(i)
                    ...
                    this.splitText = function () {
                        ...
                        return j.isText(i) && !j.isEdgePoint(this.getEndPoint()) && i.splitText(k),
                            j.isText(b) && !j.isEdgePoint(this.getStartPoint()) && (c.sc = b.splitText(h),
                                c.so = 0,
                                a && (c.ec = c.sc,
                                    c.eo = k - h)),
                ...
                this.isOnEditable = m(j.isEditable),
                    ...
                    this.wrapBodyInlineWithPara = function () {
                        if (j.isBodyContainer(b) && j.isEmpty(b))
                            return b.innerHTML = j.emptyPara,
                        ...
                        if (e = e.concat(j.listNext(a.nextSibling, j.isParaInline)),
                            e.length) {
                    ...
                    this.getWordRange = function (a) {
                        ...
                        return a && (b = j.nextPointUntil(b, function (a) {
                            return !j.isCharPoint(a)
                        })),
        ...
        return {
            ...
            createFromNode: function (a) {
                var b = a
                    ...
                    , d = a
                    , e = j.nodeLength(d);
                return j.isVoid(b) && (c = j.listPrev(b).length - 1,
                    b = b.parentNode),
                    j.isBR(d) ? (e = j.listPrev(d).length - 1,
                        d = d.parentNode) : j.isVoid(d) && (e = j.listPrev(d).length,
                            d = d.parentNode),
                    this.create(b, c, d, e)
            },
        ...
        this.stylePara = function (b, c) {
                ...
                if (e) {
                    ...
                    return a.map(k, function (b) {
                        ...
                        return a.each(e, function (a, b) {
                            j.appendChildNodes(d, b.childNodes),
                                j.remove(b)
                        }),
                            g.head(c)
                    })
            ...
            this.current = function (c, d) {
                var e = a(j.isText(c.sc) ? c.sc.parentNode : c.sc)
                    ...
                    , g = b(e, f) || {};
                if (g["font-size"] = parseInt(g["font-size"], 10),
                    g["font-bold"] = document.queryCommandState("bold") ? "bold" : "normal",
                    g["font-italic"] = document.queryCommandState("italic") ? "italic" : "normal",
                    g["font-underline"] = document.queryCommandState("underline") ? "underline" : "normal",
        ...
        this.insertOrderedList = function () {
            ...
            this.wrapList = function (b, c) {
                ...
                return b = a.map(b, function (a) {
                    ...
                    h && (j.appendChildNodes(i, g.from(h.childNodes)),
                        j.remove(h)),
                    b
            }
            ,
        ...
        this.insertTab = function (a, b, c) {
            ...
            this.insertParagraph = function () {
                ...
                var d, e = j.ancestor(c.sc, j.isPara);
                if (e) {
        ...
        this.undo = function (a) {
            ...
            ;
        for (var n = this.beforeCommand = function (a) {
            i(a)
        }
            ...
            , t = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "formatBlock", "removeFormat", "backColor", "foreColor", "insertHorizontalRule", "fontName"], u = 0, v = t.length; v > u; u++)
            this[t[u]] = function (a) {
                return function (b, c) {
                    n(b),
        ...
        this.tab = function (a, b) {
            var c = k.create();
            c.isCollapsed() && c.isOnCell() ? d.tab(c) : (n(a),
                f.insertTab(a, c, b.tabsize),
                o(a))
        }
            ,
            this.untab = function () {
            ...
            this.insertOrderedList = function (a) {
                n(a),
                    h.insertOrderedList(a),
                    o(a)
            }
            ,
            this.insertUnorderedList = function (a) {
                n(a),
                    h.insertUnorderedList(a),
                    o(a)
            }
            ,
            ...
            this.insertNode = function (a, b) {
                ...
                c.insertNode(b),
                    k.createFromNode(b).collapse().select(),
                    o(a)
            }
            ,
            this.insertText = function (a, b) {
                ...
                k.create(d, j.nodeLength(d)).select(),
                    o(a)
            }
            ,
            this.pasteHTML = function (a, b) {
                ...
                var c = this.createRange(a)
                    , d = c.pasteHTML(b);
                k.createFromNode(g.last(d)).collapse().select(),
                    o(a)
            }
            ,
        ...
        this.fontSize = function (b, d) {
            ...
            this.createLink = function (b, d, e) {
                ...
                var q = k.createFromNode(g.head(m)).collapse(!0)
                    ...
                    , t = s.getEndPoint();
                k.create(r.node, r.offset, t.node, t.offset).select(),
                    o(b)
            }
            ,
            ...
            this.removeMedia = function (c, d, e) {
                n(c),
                    e.detach(),
                    b.bindCustomEvent(a(), c.data("callbacks"), "media.delete").call(e, this.$editable),
                    o(c)
            }
            ,
            this.focus = function (a) {
                a.focus(),
                    e.isFF && k.createFromNode(a[0].firstChild || a[0]).collapse().select()
            }
    }, u = function () {
        ...
        this.toggle = function (a) {
            ...
            j ? (g.data("orgheight", g.css("height")),
                c.on("resize", function () {
                    i({
                        h: c.height() - f.outerHeight()
                    })
                }).trigger("resize"),
                d.css("overflow", "hidden")) : (c.off("resize"),
                    i({
                        h: g.data("orgheight")
                    }),
        ...
        this.sync = function (b) {
            ...
            this.activate = function (c) {
                var d = c.editor()
                    ...
                    , k = c.handle()
                    , l = d.data("options");
                if (h.val(j.html(g, l.prettifyHtml)),
                    h.height(g.height()),
            ...
            this.attach = function (a, b) {
                ...
                this.attachDragAndDropEvent = function (d, e) {
                    ...
                    c.on("dragenter", function (a) {
                        ...
                        c || f.length || !j || (g.addClass("dragover"),
                            h.width(g.width()),
                            h.height(g.height()),
                        ...
                        h.on("drop", function (c) {
                            ...
                            d && d.files && d.files.length ? (g.editable().focus(),
                                b.insertImages(g, d.files)) : e ? a(e).each(function () {
                                    g.editable().focus(),
                    ...
                    return a.invoke("editor.saveNode", e),
                        ...
                        void setTimeout(function () {
                            ...
                            if (b.length && -1 !== b[0].src.indexOf("data:")) {
                                for (var c = b[0].src, f = atob(c.split(",")[1]), g = new Uint8Array(f.length), h = 0; h < f.length; h++)
                                    g[h] = f.charCodeAt(h);
                                var i = new Blob([g], {
                                    type: "image/png"
                                });
                    ...
                    b.one("shown.bs.modal", function () {
                        g.val(f.text),
                            ...
                            h.on("input", function () {
                                c(i, h.val()),
                                    f.text || g.val(h.val())
                            }).val(f.url).trigger("focus").trigger("select"),
                            d(h, i),
                            d(g, i),
                        ...
                        b.one("shown.bs.modal", function () {
                            f.replaceWith(f.clone().on("change", function () {
                                ...
                                g.on("keyup paste", function (a) {
                                    var b;
                                    b = "paste" === a.type ? a.originalEvent.clipboardData.getData("text") : g.val(),
                                        c(h, b)
                                }).val("").trigger("focus"),
                                d(g, h)
                        }).one("hidden.bs.modal", function () {
        ...
        , H = function () {
            ...
            this.insertImages = function (d, e) {
                ...
                i.onImageUpload ? c(h, i, "image.upload")(e) : a.each(e, function (a, d) {
                    var e = d.name;
                    j.maximumImageFileSize && j.maximumImageFileSize < d.size ? c(h, i, "image.upload.error")(j.langInfo.image.maximumFileSizeError) : m.readFileAsDataURL(d).then(function (a) {
            ...
            var d = {
                ...
                , p = function (c) {
                    ...
                    if (e.length) {
                        var f, h = e.attr("data-event"), k = e.attr("data-value"), l = e.attr("data-hide"), m = j.makeLayoutInfo(c.target);
                        if (-1 !== a.inArray(h, ["resize", "floatMe", "removeMedia", "imageShape"])) {
                            var n = m.handle().find(".note-control-selection");
                            f = a(n.data("target"))
                        }
                        if (l && e.parents(".popover").hide(),
            ...
            this.bindKeyMap = function (c, e) {
                ...
                g.on("keydown", function (h) {
                    ...
                    if (k)
                        if (a.summernote.pluginEvents[k]) {
                            ...
                            b.editor[k] ? (b.editor[k](g, f.data("options")),
                                h.preventDefault()) : d[k] && (d[k].call(this, c),
                                    h.preventDefault());
                    else
                        n.isEdit(h.keyCode) && b.editor.afterCommand(g)
                })
            }
                ,
                this.attach = function (a, c) {
                    c.shortcuts && this.bindKeyMap(a, c.keyMap[e.isMac ? "mac" : "pc"]),
                        ...
                        c.airMode || (a.toolbar().on("click", p),
                ...
                this.attachCustomEvent = function (b, d) {
                    ...
                    var k = e.isMSIE ? "DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted" : "input";
                    h.on(k, function () {
                        c(f, i, "change")(h.html(), h)
                    }),
                        d.airMode || (b.toolbar().click(c(f, i, "toolbar.click")),
                            b.popover().click(c(f, i, "popover.click"))),
                        j.isTextarea(g.head(f)) && f.closest("form").submit(function (a) {
        ...
        , I = function () {
            var b = function (a, b) {
                ...
                , t = {
                    ...
                    help: function (a, b) {
                        var c = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + a.shortcut.close + '</a><div class="title">' + a.shortcut.shortcuts + "</div>" + (e.isMac ? r(a, b) : s(r(a, b))) + '<p class="text-center"><a href="//summernote.org/" target="_blank">Summernote 0.6.6</a> · <a href="//github.com/summernote/summernote" target="_blank">Project</a> · <a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a></p>';
            ...
            this.createLayoutByAirMode = function (b, c) {
                ...
                this.removeLayout = function (a, b, c) {
                    c.airMode ? (a.removeClass("note-air-editor note-editable").removeAttr("id contentEditable"),
                        b.popover().remove(),
                        b.handle().remove(),
                        b.dialog().remove()) : (a.html(b.editable().html()),
                            b.editor().remove(),
                            a.show())
                }
                ,
            ...
            code: function (b) {
                if (void 0 === b) {
                    ...
                    if (e && e.length) {
                        ...
                        return K.invoke("codeview.sync", d),
