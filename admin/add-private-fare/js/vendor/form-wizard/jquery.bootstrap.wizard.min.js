...
(function(e) {
    var n = function(d, k) {
        ...
        this.next = function(h) {
            ...
            h = a.currentIndex();
            $index = a.nextIndex();
            $index > a.navigationLength() || (g.push(h),
        ...
        this.show = function(b) {
            ...
            0 < b.length && (g.push(a.currentIndex()),
            b.tab("show"))
        }
        ;
        ...
        var l = function(d) {
          ...
          , m = function(d) {
            ...
            if ($element.hasClass("disabled") || c.onTabChange && "function" === typeof c.onTabChange && !1 === c.onTabChange(f, b, a.currentIndex(), d))
                return !1;
            f = $element;
